const designspaces = [
  {
    ...
    children: [
      ...
      },
      {
        title: "BOSS 设计",
        desc: "个人博客收集",
        imgurl: "./static/img/app/BOSS.png",
  ...
  }, 
  {
    ...
    children: [
      ...
      },
      {
        title: "rawpixel",
        desc: "超级好用 免版权 【元素素材】",
        imgurl: "./static/img/app/rawpixel.svg",
...
const navLists = Vue.reactive([
  {
    ...
    children: [
      ...
      {
        title: "HitPaw",
        desc: "模糊图片+视频变清晰，可用于老照片处理，4K视频制作",
        imgurl: "./static/img/app/HitPaw.webp",
        url: "http://www.hitpaw.com/",
      },
      {
        title: "电子包浆",
        desc: "照片做旧【免费】",
        imgurl: "./static/img/app/jiu.png",
        url: "https://magiconch.com/patina/",
      },
      {
        title: "DEVICE SHOTS",
        desc: "图片套外壳【手机、电脑】",
        imgurl: "./static/img/app/DEVICESHOTS.png",
        url: "https://deviceshots.com/app?device=apple-iphone-x",
      },
      {
        title: "Watermarkre Mover",
        desc: "免费去图片水印",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        url: "https://www.weta365.com/conduct",
      },
      {
        title: "song R",
        desc: "【免费】AI生成歌曲",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: "AE常见问题汇总",
        imgurl: "./static/img/app/ae2022.jpg",
        url: "https://space.bilibili.com/24624223/channel/collectiondetail?sid=433382",
      },
      {
        title: "PR 100道练习题",
        desc: "PS常见问题汇总",
        imgurl: "./static/img/app/pr2022.jpg",
        url: "https://www.bilibili.com/video/BV1u14y1q7SZ/?spm_id_from=333.999.0.0",
      },
      {
        title: "PS 100问",
        desc: "PS常见问题汇总",
...
const designnorm = [
  {
    ...
    children: [
      ...
      {
        title: "苹果截屏规范",
        desc: "上传到appstore的飞机稿",
        imgurl: "./static/img/app/apple.png",
        url: "https://developer.apple.com/cn/help/app-store-connect/reference/screenshot-specifications",
      },
      {
...
const iconDesigns = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: "Figma图标库",
        imgurl: "./static/img/app/untitledui.png",
    ...
    children: [
      {
        ...
        imgurl: "./static/img/app/GoView.png",
        url: "https://vue.mtruning.club/#/project/items",
      },
      {
        title: "GoView 源码",
        desc: "gitee源码",
...
const devlist = [
  ...
  },
  {
    ...
    children: [
      {
        title: "API POST",
        desc: "可直接生成文档的API调试、管理工具",
        imgurl: "./static/img/app/apipost.svg",
        url: "https://v7.apipost.cn/?utm_source=10147#/apis/run",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        desc: "学习一体化",
        imgurl: "./static/img/app/worldvectorlogo.png",
        url: "https://c.runoob.com/web-developer/",
      },
      {
        title: "腾讯云开发社区",
        desc: "开发文档资源",
        imgurl: "./static/img/app/txy.png",
        url: "https://cloud.tencent.com/developer/doc/1018",
      },
    ],
  },
  {
    ...
    children: [
      {
        title: "BootCDN",
        desc: "稳定、快速、免费的前端开源项目 CDN 加速服务，共收录了 3934 个前端开源项目",
        imgurl: "./static/img/app/BootCDN.png",
        url: "https://www.bootcdn.cn/",
      },
      {
        title: "jsDelivr【国外，不需翻墙】",
        desc: "jsDelivr是唯一拥有国内颁发的有效ICP许可证的公共CDN",
        imgurl: "./static/img/app/jsDelivr.svg",
        url: "https://www.jsdelivr.com/",
      },
      {
        title: "字节跳动静态资源库",
        desc: "资源库很齐全",
        imgurl: "./static/img/app/bytecdn.png",
        url: "https://cdn.bytedance.com/",
      },
      {
        title: "cdnjs【国外，不需翻墙】",
        desc: "免费的开源 CDN 服务",
        imgurl: "./static/img/app/cdnjs.svg",
        url: "https://cdnjs.com/",
      },
      {
        title: "Jquery CDN【国外，不需翻墙】",
        desc: "只有JQ",
        imgurl: "./static/img/app/jquerycdn.png",
...
const PMlists = [
  ...
  },
  {
    ...
    children: [
      {
        title: "UXD高端汁源库",
        desc: "产品经理、交互设计师学习进阶资源群简介",
        imgurl: "./static/img/app/uxdgdzyk.png",
        url: "https://www.yuque.com/uxd-resource",
      },
    ],
  },
  {
    ...
    children: [
      {
        title: "17素材",
        desc: "网页模板参考",
        imgurl: "./static/img/app/17sucai.png",
        url: "https://www.17sucai.com/",
      },
      {
        title: "素材8",
        desc: "代码素材",
        imgurl: "./static/img/app/sucai8.png",
        url: "http://www.sucai8.cn/",
      },
      {
        title: "PP Chart",
        desc: "echart的代码素材仓库",
        imgurl: "./static/img/app/sucai8.png",
        url: "http://www.ppchart.com/#/",
      },
    ],
  },
];
    ...
    children: [
      {
        title: "Hasleo NTFS",
        desc: "提取码: k7nf",
        imgurl: "./static/img/app/Hasleo.png",
        url: "https://pan.baidu.com/s/1GXB-1ncuzhYNa50VubTJdw",
      },
      {
        title: "OmiNTFS",
        desc: "提取码: 4r6h",
        imgurl: "./static/img/app/OmiNTFS.png",
        url: "https://pan.baidu.com/share/init?surl=R0IqG-aCMoE7g8Y25xX9FA",
      },
      {
        title: "XDisk",
        desc: "app store 应用商城下载",
        imgurl: "./static/img/app/XDisk.png",
        url: "https://apps.apple.com/cn/app/id1461463493",
      },
      {
        title: "Tuxera",
        desc: "不免费",
        imgurl: "./static/img/app/TuxeraNTFS.png",
        url: "https://download.tuxera.com/mac/tuxerantfs_2021.1.dmg",
      },
      {
        title: "Mounty",
        desc: "提取码: 4teb",
        imgurl: "./static/img/app/Mounty.png",
        url: "https://pan.baidu.com/share/init?surl=NN57qfUE_BI-DQj4oCL1-A",
      },
    ],
  },
];
    ...
    children: [
      {
        ...
        title: "淘宝联盟-商家中心",
        desc: "淘宝营销",
        imgurl: "./static/img/app/tblm.png",
        url: "https://ad.alimama.com/user/account/settings.htm",
      },{
        title: "1688学习中心",
        desc: "自动分销操作流程",
        imgurl: "./static/img/app/1688.png",
    ...
    children: [
      {
        title: "抖音小厨",
        desc: "巨量百营应",
        imgurl: "./static/img/app/dyxc.png",
